 ...
 *
 * De keys ("chloe", "melanie", …) zijn stabiel: ze zitten in de
...
export const TTS_VOICES = {
  ...
  melanie: { label: "Melanie", description: "Warme vertelster",  gender: "female", accent: "NL",     voiceId: "SXBL9NbvTrjsJQYay2kT" },
  ...
  robert:  { label: "Robert",  description: "Diep & warm",       gender: "male",   accent: "NL",     voiceId: "cblS8WYNsiBLGnlV6jjx" },
